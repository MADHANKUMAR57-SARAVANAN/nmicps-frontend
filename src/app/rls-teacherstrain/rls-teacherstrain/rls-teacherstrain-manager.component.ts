...
@Component({
  ...
  templateUrl: './rls-teacherstrain-manager.component.html',
  styleUrls: ['./rls-teacherstrain-manager.component.scss']
})
export class RLSteacherstrainManagerComponent implements OnInit {
  ...
  addDevice() {
    this.router.navigate(['rls-teacherstrain/rls-teacherstrain-creation']);
  }
  GetStates(): void {
