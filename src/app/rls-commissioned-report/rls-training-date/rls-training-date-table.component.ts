...
@Component({
  ...
  templateUrl: './rls-training-date-table.component.html',
  styleUrls: ['./rls-training-date-table.component.scss']
})
export class RLSTrainingDateTableComponent implements OnInit {
