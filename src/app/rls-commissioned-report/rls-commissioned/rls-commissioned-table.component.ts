...
@Component({
  ...
  templateUrl: './rls-commissioned-table.component.html',
  styleUrls: ['./rls-commissioned-table.component.scss']
})
export class RLSCommissionedTableComponent implements OnInit {
