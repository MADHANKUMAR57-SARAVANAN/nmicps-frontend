...
@Component({
  ...
  templateUrl: './rls-shipped-table.component.html',
  styleUrls: ['./rls-shipped-table.component.scss']
})
export class RLSShippedTableComponent implements OnInit {
  ...
  Shipped_Details() {
    ...
    this.rest.Shipped_table(webToken).subscribe((result) => {
