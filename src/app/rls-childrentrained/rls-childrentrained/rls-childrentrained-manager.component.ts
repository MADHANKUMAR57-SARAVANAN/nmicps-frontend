...
@Component({
  ...
  templateUrl: './rls-childrentrained-manager.component.html',
  styleUrls: ['./rls-childrentrained-manager.component.scss']
})
export class RLSchildrentrainedManagerComponent implements OnInit {
  ...
  addDevice() {
    this.router.navigate(['rls-childrentrained/rls-childrentrained-creation']);
  }
  GetStates(): void {
