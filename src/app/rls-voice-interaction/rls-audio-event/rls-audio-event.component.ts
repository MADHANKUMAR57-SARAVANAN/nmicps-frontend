...
@Component({
  ...
  templateUrl: './rls-audio-event.component.html',
  styleUrls: ['./rls-audio-event.component.scss']
})
export class RLSAudioEventComponent implements OnInit {
 public audio_datas: any[];
...
districtChange(event: any) {
 ...
 GetStates(): void {
  ...
  audio_data() {
    ...
    this.rest.get('device/getaudio_data').subscribe((result) => {
       
       this.audio_datas = result.data;
     setTimeout(function() {
