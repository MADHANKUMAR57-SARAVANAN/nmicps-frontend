...
@Component({
  ...
  templateUrl: './rls-kitshipped-manager.component.html',
  styleUrls: ['./rls-kitshipped-manager.component.scss']
})
export class RLSkitshippedManagerComponent implements OnInit {
  ...
  addDevice() {
    this.router.navigate(['rls-kitshipped/rls-kitshipped-creation']);
  }
  GetStates(): void {
