...
@Component({
  ...
  templateUrl: './rls-mobilesnapshot-details.component.html',
  styleUrls: ['./rls-mobilesnapshot-details.component.scss']
})
export class RLSMobilesnapshotDetailsComponent implements OnInit {
  ...
  constructor(private router: Router, private activatedRoute: ActivatedRoute, private rest: DynamicScriptLoaderService, private fb: FormBuilder, public toastr: ToastrManager, ) { }
